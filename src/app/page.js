...
export default function Home() {
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      {/* Navigation Bar */}
      <nav className="fixed top-0 w-full bg-white/95 dark:bg-black/95 backdrop-blur-sm shadow-sm border-b border-light-gray dark:border-dark-gray p-4 z-50">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <h1 className="text-lg font-semibold text-black dark:text-white animate-fadeIn">
            Riddhi Gangbhoj
          </h1>
          ...
          <div className="flex gap-6">
            {["Home", "About", "Projects", "Resume"].map((item, index) => (
              <a
                ...
                className="hover:text-muted-pink transition-colors relative group animate-slideDown text-sm text-black dark:text-white"
      ...
      <main className="pt-20 px-4">
        <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between py-20 gap-8">
          <div className="md:w-1/2 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a 
                href="/resume.pdf" 
                className="border border-muted-pink text-muted-pink px-5 py-2 rounded-full hover:bg-soft-pink/30 dark:hover:bg-muted-pink/10 transition-colors text-sm font-medium"
              >
                Download Resume
              </a>
            </div>
        ...
        <section id="projects" className="max-w-6xl mx-auto py-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Project 1 */}
            <div className="border border-light-gray dark:border-dark-gray rounded-lg p-6 hover:shadow-lg hover:shadow-soft-pink/10 transition-all duration-300 bg-light-gray/50 dark:bg-dark-gray/50 hover:border-soft-pink/30 dark:hover:border-muted-pink/30">
              <h4 className="text-lg font-semibold mb-2 text-black dark:text-white">GSoC Project</h4>
